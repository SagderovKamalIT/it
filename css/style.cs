...
.career::before {
  position: absolute;
  content: "";
  background: url(/managment-in-IT/assets/icons/double-lines.svg) no-repeat;
...
.career::after {
  position: absolute;
  content: "";
  background: url(/managment-in-IT/assets/icons/long-line.svg) no-repeat;
...
.career__section {
  ...
  justify-content: space-between;
  gap: 5.625rem;
  background: url(/managment-in-IT/assets/icons/bracket.svg) no-repeat;
  background-repeat: no-repeat;
...
@media (max-width: 460px) {
  ...
  .career::after {
    background: url(/managment-in-IT/assets/icons/career-line.svg) no-repeat;
    background-position: bottom left;
    background-size: contain;
    bottom: 0;
    left: 0;
...
.education::after {
  position: absolute;
  content: "";
  background: url(/managment-in-IT/assets/icons/education-long-line.svg) no-repeat;
  background-size: contain;
  background-position: bottom left;
  width: 80rem;
  height: 6rem;
...
.education__container::after {
  position: absolute;
  content: "";
  background: url(/managment-in-IT/assets/icons/education-vertical-line.svg) no-repeat;
  background-size: contain;
...
.admission__list::before {
  position: absolute;
  content: "";
  background: url(/managment-in-IT/assets/icons/admission-vertical-line.svg) no-repeat;
  background-size: contain;
  left: 0;
  top: 0;
  width: 10rem;
...
.footer__contacts-button button {
  border: 0.25rem solid #FFFFFF;
  background-color: #FFFFFF;
  border-radius: 1.875rem;
  color: #054B71;
...
.footer__contacts-button button:hover {
  border: 0.25rem solid #FFFFFF;
...
.footer__contacts-button button a {
  color: #054B71;
  text-decoration: none;
  padding: 3.344rem 1.906rem;
}
.footer__contacts-button button a:hover {
  color: #FFFFFF;
}
.footer__address {
  display: flex;
